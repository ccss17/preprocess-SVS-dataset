...
# rprint(mssv.find_exclusive_two_type_files("*.mid", "*.wav", mssv_midi_path, mssv_wav_path))
...
rprint(mssv.find_exclusive_two_type_files("*.mid", "*.json", mssv_midi_path, split_json_dirpath))
